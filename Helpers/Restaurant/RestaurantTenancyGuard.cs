...
{
    /// <summary>Garde-fous multi-tenant pour le module restaurant (JWT / Super-Admin).</summary>
    public static class RestaurantTenancyGuard
    {
        ...
        /// <summary>
        /// Résolution stricte (écritures) : tout JWT avec société est tenanté.
        ...
        /// <summary>
        /// Résolution pour listes catalogue restaurant.
        /// Retourne un tenant seulement pour le personnel société (<see cref="ICurrentUserService.IsStaff"/>).
        /// Clients / anonymes / non-staff → <c>false</c> (catalogue Published global).

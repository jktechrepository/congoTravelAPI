...
{
    /// <summary>Garde-fous multi-tenant pour le module site touristique (JWT / Super-Admin).</summary>
    public static class SiteTouristiqueTenancyGuard
    {
        ...
        /// <summary>
        /// Résolution pour <c>GET /api/sites-touristiques/journees</c> (catalogue).

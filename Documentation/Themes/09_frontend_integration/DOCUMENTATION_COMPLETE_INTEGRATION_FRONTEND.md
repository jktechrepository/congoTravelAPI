...
| Type | Format |
|------|--------|
| Dates | ISO-8601 UTC (`2026-05-08T17:00:00Z`) |
| Heures voyage | String `HH:mm:ss` (`08:30:00`) — **pas** d'objet TimeSpan |
...
- La plupart des endpoints filtrent automatiquement par société du token.
...
Événements utiles :
- `FlexPayPaymentConfirmed` / `FlexPayPaymentFailed` — paiement transport
- Notifications in-app

Référence : [`Documentation/SignalR-Integration.md`](../../SignalR-Integration.md), [`docs/SIGNALR_FRONTEND_GUIDE.md`](../../../docs/SIGNALR_FRONTEND_GUIDE.md)
...
- [ ] SignalR notifications paiement
...
| SignalR | [`Documentation/SignalR-Integration.md`](../../SignalR-Integration.md) |

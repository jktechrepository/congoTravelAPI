...
> **Breaking change v1 (transport)** : les noms d'événements SignalR restent inchangés, mais les payloads utilisent désormais `StatistiquesTransportDto` (réservations, voyages, billets, taux paiement) à la place du modèle Kenergie (factures, arriérés, recouvrement).
...
```json
{
  ...
  "statistiques": {
    ...
    "montantReservationsNonPayees": 25000.00,
    "tauxPaiement": 85.5,
...
```json
{
  ...
  "statistiques": {
    ...
    "montantDu": 75000.00,
    "evolutionMensuelle": [
      { "mois": "janv. 2026", "chiffreAffaires": 42000, "nombrePaiements": 12, "nombreReservations": 15 }
    ],
...
```json
{
  "societeId": 1,
  "statistiques": {
    "tauxPaiementGlobal": 85.5,
    "topAgents": [...],
    "performanceMensuelle": [
      { "mois": "janv. 2026", "tauxPaiement": 88.0, "montantCollecte": 42000, "nombrePaiements": 12, "ticketMoyen": 3500 }
    ],
    "dateGeneration": "2026-02-14T16:30:00Z"
  },
  "timestamp": "2026-02-14T16:30:00Z",

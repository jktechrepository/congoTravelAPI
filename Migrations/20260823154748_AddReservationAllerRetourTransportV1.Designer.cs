...
namespace CongoTravel.Migrations
{
    ...
    [Migration("20260823154748_AddReservationAllerRetourTransportV1")]
    partial class AddReservationAllerRetourTransportV1
    {
            ...
            modelBuilder.Entity("CongoTravel.Models.Evenement.EvenementSession", b =>
                {
                    ...
                    b.Property<string>("LogoOrganisateur")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
            ...
            modelBuilder.Entity("CongoTravel.Models.ReservationAllerRetour", b =>
                {
                    ...
                    b.ToTable("ReservationsAllerRetour");
                });
            ...
            modelBuilder.Entity("CongoTravel.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("CongoTravel.Models.ReservationAllerRetour", null)
                        .WithMany("Reservations")

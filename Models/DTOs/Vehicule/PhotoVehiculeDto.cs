...
namespace CongoTravel.Models.DTOs
{
    ...
    public class AddPhotoVehiculeDto
    {
        /// <summary>Image encodée en base64 (avec ou sans préfixe data:image/...;base64,).</summary>
        public string PhotoBase64 { get; set; } = string.Empty;

        /// <summary>Alias historique (ancienne colonne FilePath / payload front « filePath »).</summary>
        ...
        /// <summary>Alias front courant (« photo » au lieu de « photoBase64 »).</summary>
    ...
    public class UpdatePhotoVehiculeOrdreDto
    {
        public int Ordre { get; set; }
    }
}
